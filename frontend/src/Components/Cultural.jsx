  ...
  return (
    ...
    <div className='lg:grid lg:grid-cols-2 lg:gap-10 items-center'>
      <div className='flex lg:gap-10 gap-6  flex-col'>
        <h1 className='text-yellow-400 text-xl font-bold sm:font-bold sm:font-mono sm:text-6xl xl:text-7xl'>DYNAMIC <h1 className='text-white'>NETWORKSCAPE</h1></h1>
      ...
      <div>
        <img src="/image/pic1.png" alt="" className='w-full h-full object-contain' />
      </div>
    </div>
  </div>
  )
