        ...
        <div className='my-20 py-10 md:px-20 px-8 bg-dry'>
            <div className='lg:grid lg:grid-cols-2 lg:gap-10 items-center'>
                ...
                <div className='flex lg:gap-10 gap-6  flex-col'>
                    <h1 className='text-yellow-400 text-xl font-bold sm:font-bold sm:font-mono sm:text-6xl '>DYNAMIC
                        <p className='text-white'> NETWORKSCAPE</p></h1>
                    <p className='text-text font-normal text-sm xl:text-base leading-6 xl:leading-8'>
